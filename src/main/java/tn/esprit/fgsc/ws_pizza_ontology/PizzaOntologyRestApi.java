...
public class PizzaOntologyRestApi {
    ...
    private static OntModel readModel() {
    ...
    @GetMapping("/ontology")
    public List<Map<String, String>> getontologies() {
        List<Map<String, String>> list = new ArrayList();
        Iterator<Ontology> ontologiesIter = readModel().listOntologies();
        while (ontologiesIter.hasNext()) {
            Ontology ontology = ontologiesIter.next();
